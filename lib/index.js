...
module.exports = {
  ...
  detectInstalledAgents: agentsModule.detectInstalledAgents,
  getCanonicalDir: agentsModule.getCanonicalDir,
  getAgentSkillsDir: agentsModule.getAgentSkillsDir,
  getAllAgentNames: agentsModule.getAllAgentNames,
  getAgentConfig: agentsModule.getAgentConfig,
  parseAgentArg: agentsModule.parseAgentArg,

  // 交互式安装
  runInteractiveInstall: interactiveInstaller.runInteractiveInstall,
  runInteractiveStatus: interactiveInstaller.runInteractiveStatus,
  selectAgentsInteractive: interactiveInstaller.selectAgentsInteractive,
  ...
  INSTALL_MODE_CANONICAL_COPY: installer.INSTALL_MODE_CANONICAL_COPY,
  INSTALL_MODE_REPO_LINK: installer.INSTALL_MODE_REPO_LINK
};
