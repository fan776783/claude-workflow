...
**文档版本**：v7.0.0
**最后更新**：2026-02-12
**包版本**：@pic/claude-workflow v3.2.0
...
│   ├── meta.json                   # 版本信息
│   └── backups/                    # 升级备份
├── skills/                         # 10 个 Skill（支持 references 渐进加载）
