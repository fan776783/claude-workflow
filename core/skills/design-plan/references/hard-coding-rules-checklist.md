...
> 由 `/design-plan` Step 3 使用。技术方案落盘前对 5 条 Hard Coding Rules 逐条标注"是否触及 / 如何遵循 / 例外说明"。
>
> 红线源:`AGENTS.md § Hard Coding Rules`(若该文件不存在,fallback 到 `docs/engineering/rules.md`)。
