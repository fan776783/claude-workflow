...
created_at: "2026-04-07T10:39:49.433Z"
status: draft
role: team-spec
---

# Team Spec: boundary board smoke requirement (Team)

## 1. Context

- 原始需求来源: inline
- Team mode: explicit invocation only
- 需求摘要: boundary board smoke requirement

## 2. Scope

### 2.1 In Scope

- R1: boundary board smoke requirement
...
- 以 team 模式协作完成：boundary board smoke requirement
...
- .claude/specs/boundary-test-runtime.team.md
- .claude/plans/boundary-test-runtime.team.md
- .claude/plans/boundary-test-runtime.team-tasks.md

## 7. Acceptance Criteria

- [ ] boundary board smoke requirement
- [ ] Team mode 保持显式触发
- [ ] 现有 /workflow 不被自动升级
