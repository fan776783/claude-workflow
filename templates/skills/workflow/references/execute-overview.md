...
- 想判断“继续”到底会不会恢复执行：看“自然语言控制”与 `references/execute-entry.md`
...
- 想看审查触发规则：看 Step 6 与 `specs/execute/subagent-review.md`
- 想看统一 CLI / 脚本入口：看 `references/shared-utils.md`
...
**详细实现**: 参见 `specs/execute/context-governor.md`、`specs/execute/subagent-routing.md`、`../dispatching-parallel-agents/SKILL.md` 与 `references/shared-utils.md`
...
使用 `scripts/workflow_cli.py journal add` 持久化会话进展，确保新 Session 启动时可恢复上下文：

```bash
python3 scripts/workflow_cli.py journal add \
  --title "完成 T1-T3 任务" \
