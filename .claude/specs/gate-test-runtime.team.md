...
created_at: "2026-04-07T10:25:25.548Z"
status: draft
role: team-spec
---

# Team Spec: test team start gate requirement (Team)

## 1. Context

- 原始需求来源: inline
- Team mode: explicit invocation only
- 需求摘要: test team start gate requirement

## 2. Scope

### 2.1 In Scope

- R1: test team start gate requirement
...
- 以 team 模式协作完成：test team start gate requirement
...
- .claude/specs/gate-test-runtime.team.md
- .claude/plans/gate-test-runtime.team.md
- .claude/plans/gate-test-runtime.team-tasks.md

## 7. Acceptance Criteria

- [ ] test team start gate requirement
- [ ] Team mode 保持显式触发
- [ ] 现有 /workflow 不被自动升级
