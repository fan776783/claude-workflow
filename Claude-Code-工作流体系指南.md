...
```bash
# 全局安装（推荐）
npm install -g @pic/claude-workflow --registry http://10.10.19.68:4873

# 或作为开发依赖
npm install -D @pic/claude-workflow --registry http://10.10.19.68:4873
```
...
```bash
npm update -g @pic/claude-workflow --registry http://10.10.19.68:4873
```
