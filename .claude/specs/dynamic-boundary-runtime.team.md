...
# Team Spec: dynamic boundary board requirement (Team)

## 1. Context

- 原始需求来源: inline
- Team mode: explicit invocation only
- 需求摘要: dynamic boundary board requirement

## 2. Scope

### 2.1 In Scope

- R1: dynamic boundary board requirement
...
- 以 team 模式协作完成：dynamic boundary board requirement
...
- [ ] dynamic boundary board requirement
- [ ] Team mode 保持显式触发
- [ ] 现有 /workflow 不被自动升级
