...
**详细实现**: 参见 `../../../specs/workflow-runtime/shared-utils.md` 与 `../../../utils/workflow/path_utils.py`
...
使用 `../../../utils/workflow/workflow_cli.py journal add` 持久化会话进展，确保新 Session 启动时可恢复上下文：

```bash
python3 ../../../utils/workflow/workflow_cli.py journal add \
  --title "完成 T1-T3 任务" \
...
**详细实现**: 参见 `../../../specs/workflow-runtime/external-deps.md`、`../../../specs/workflow-runtime/state-machine.md` 与 `../../../utils/workflow/dependency_checker.py`
